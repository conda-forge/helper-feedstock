About helper-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/helper-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3010&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/helper-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `helper` can be installed with `conda`:
...
It is possible to list all of the versions of `helper` available on your platform with `conda`:
...
```
mamba search helper --channel conda-forge
```
...
mamba repoquery search helper --channel conda-forge

# List packages depending on `helper`:
mamba repoquery whoneeds helper --channel conda-forge

# List dependencies of `helper`:
mamba repoquery depends helper --channel conda-forge
```
